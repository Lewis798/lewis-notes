...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Bjarne Stroustrup cpp',
        desc: 'C++之父博客文章中文版',
        link: 'https://www.stroustrup.com/bsfaqcn.html'
      },
      {
        badge: '周一更新',
      ...
      {
        icon: 'https://tproay-markdown.oss-cn-beijing.aliyuncs.com/tproay-markdown/202407101040949.jpg',
        title: '小傅哥',
        desc: 'ava 基础，面经手册，Netty4.x，手写Spring，用Java实现JVM，重学Java设计模式，SpringBoot中间件开发，IDEA插件开发，Lottery抽奖系统，字节码编程..',
      ...
      {
        icon: 'https://abseil.io/img/absl_80px.png',
        title: 'Abseil ',
        desc: '开源的C++库集合',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://tproay-markdown.oss-cn-beijing.aliyuncs.com/tproay-markdown/202407101102148.png',
        title: 'Spring Boot初学者指南',
        desc: '教程资源包括Spring靴子，涵盖了基本概念，如注释和自动配置，以及高级概念，如打包，部署和监控',
        link: 'https://howtodoinjava.com/'
      },
      {
        icon: 'https://mysqljiaocheng.com/wp-content/uploads/2021/04/mysql-stored-procedure.svg',
        title: 'MySQL Tutorial',
        desc: '网站以简单易懂的方式为您提供了完整的 MySQL 教程。每个教程都有带有 SQL 脚本和屏幕截图的实际示例！',
        link: 'https://mysqljiaocheng.com/'
      },
      {
        icon: 'https://th.bing.com/th?id=OSK.975a9c7d8b6395ef609f5fb5e47123d5&w=102&h=102&c=7&o=6&dpr=1.5&pid=SANGAM',
        title: '鸟哥私房菜',
        desc: 'Linux学习网站（大佬力推）',
      ...
      {
        badge: '官网',
        icon: 'https://bkimg.cdn.bcebos.com/pic/faf2b2119313b07eca80a2d58a9d862397dda0442691?x-bce-process=image/resize,m_lfit,w_290,h_290,limit_1',
        title: 'C++社区网站',
        desc: 'Standard C++ Library reference标准C++库参考',
